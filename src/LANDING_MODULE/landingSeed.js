    ...
    aboutMe: {
        personality: {
            eng: {
                ...
                text: ` By nature I am a friendly and polite person. I have great demands from myself and work what i do. If I see and understand a goal while doing work, I will do my best to achieve it as quickly and efficiently as possible. I have a great sense of responsibility towards both my employer and the work I do.`,
            },
            lv: {
                title: "Personība",
                text: `Pēc dabas esmu draudzīga un pieklājīga persona. Augstas prasības pret sevi un to, ko es daru. Ja veicot darbu, redzu un saprotu mērķi, darīšu visu, lai to sasniegtu maksimāli ātri un efektīvi. Piemīt liela atbildības sajūta gan pret savu darba devēju, gan arī pret darāmo darbu. `,
            },
        },
        hobbies: {
            eng: {
                title: "Interests / hobbies",
                text: `In my free time I do individual sports – running, swimming (including winter swimming) and going to the gym. I like any kind of active recreation both outdoors and indoors. I follow the sports news in the world. I regularly try to read books in both Latvian and English.`,
            },
            lv: {
                title: "Intereses / vaļasprieki",
                text: `Brīvajā laikā nodarbojos ar indivinduālo sportu – skrienu, peldu, tai skaitā ziemas peldes, un eju uz sporta zāli. Patīk jebkāda veida aktīvā atpūta gan pie dabas, gan arī iekštelpās. Sekoju līdzi sporta jaunumiem pasaulē. Nodarbojos arī ar ziemas peldēm. Regulāri cenšos lasīt grāmatas gan latviešu, gan angļu valodā.`,
            },
        },
        goals: {
            eng: {
                title: "Goals",
                text: `For now, my biggest goal is to change my career and becoma a full time programmer. Interest and motivation is big. I like the idea that the industry is constantly evolving, which means that there is an opportunity to continuously develop yourself, as well as see the results of your work. For the last couple of years, I have spent a lot of my free time learning programming, more precisely in WEB development. Thanks to knowledge that i have gained i feel like im now able and ready to work as a programmer. I have focused on both client side programming (HTML, CSS, JS - React framework) and server side (Node - ExpressJS framework). I have also experience in working with the MongoDB database, more precisely the Mongoose framework. Although I feel confident in what I have learned, I do not think I am an expert, but im investing a lot of my free time day after day to reach my goal. Although at the moment in self learning I am focused on these technologies mentioned above, I am also open to offers to learn something new and go in other directions.`,
            },
            lv: {
                title: "Mērķi",
                text: `Uz šo brīdi lielākais mērķis ir mainīt savu karjeru un kļūt par pilna laika programmētāju. Interese un motivācija ir liela. Patīk doma, ka nozare nemitīgi attīstās, kas nozīmē to, ka ir iespēja nepārtraukti arī attīstīt sevi, tāpat arī redzēt darba rezultātu. Pēdējos pāris gadus esmu veltījis daudz sava brīvā laika programmēšanas apgūšanai, precīzāk WEB izstrādē. Pateicoties apgūtajām zināšanām, jūtu, ka esmu spējīgs un gatavs strādāt par programmētāju. Esmu koncentrējies gan uz klienta puses programmēšanu (HTML, CSS, JS – React frameworks), gan arī servera pusi (Node – ExpressJS frameworks). Ir pieredze arī darbā ar MongoDB datubāzi, precīzāk Mongoose framework. Neatkarīgi no tā, ka es jūtos pārliecināts tajā, ko es esmu apguvis, nedomāju, ka esmu eksperts, bet ikdienā turpinu cītīgi iet uz savu mērķi. Lai gan pašmācības procesā esmu koncentrējies uz iepriekš minētajām tehnoloģijām, esmu atvērts arī piedāvājumiem apgūt kautko jaunu un doties citos virzienos.`,
            },
        },
    },
    education: [
        {
            ...
            eng: {
                ...
                education:
                    "Bachelor's degree in the study program - Organizational Management",
            },
            lv: {
                diploms: {
                    gads: "2016",
                ...
                izglitiba:
                    "Bakalaura grāds studiju programmā - Organizāciju vadība",
            },
        },
        {
            type: "education",
    ...
    workExp: [
        {
            ...
            lv: {
                company: "SIA Elux",
                profession:
                    "Vairumtirdzniecības iepirkumu menedžeris / klientu atbalsts",
...

        {
            ...
            lv: {
                company: "SIA Xnet",
                profession:
                    "Internetveikala iepirkumu/klientu apkalpošanas menedžeris",
