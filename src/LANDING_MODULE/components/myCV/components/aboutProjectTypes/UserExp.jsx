            ...
            {lang === "eng" ?
                <div>
                    ...
                    <p>The project has <span className="user__highlights">authentication</span>. The user can register and log in if they are already registered.
                        The user is authorized to access and <span className="user__highlights">change only their own content</span> - add, edit and delete also edit their profile data.
                ...
                <div>
                    ...
                    <p>Projektā ir <span className="user__highlights">autentifikācija</span>. Lietotājs var reģistrēties un ienākt sistēmā, ja jau ir reģistrēts.
                        Lietotājs ir autorizēts piekļūt un <span className="user__highlights">ietekmēt tikai savu saturu</span> – pievienot, rediģēt un dzēst savu saturu,
